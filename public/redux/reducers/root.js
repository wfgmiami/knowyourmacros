...
import { CHANGE_DAY, CONFIRM_RECORD, CREATE_PROGRAM, DESTROY_MEASUREMENT, LOGIN_SUCCESS, LOGOUT_SUCCESS, INVALID_LOGIN, RECEIVE_FOOD_RECORD, RECEIVE_GOALS, RECEIVE_MEASUREMENTS, RECEIVE_PROGRAMS, RECEIVE_USER, REMOVE_FOOD_RECORD_ITEM, REQUEST_DATA, SAVE_BMR_CALORIES, UPDATE_RECORD, UPDATE_RECORD_QUANTITY } from '../constants';
...
export default (state = initialState, action) => {
  ...
  /** Update the meal for the food record */
  case UPDATE_RECORD:
    newState = changeState();
 ...
 * @param {object} param0
 * @param {[{pGoal: number, cGoal: number, fGoal: number}]} param0.trainingGoals
 * @param {[{pGoal: number, cGoal: number, fGoal: number}]} param0.restingGoals
 */
